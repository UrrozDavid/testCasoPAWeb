...
/// </summary>
public class PAWCP2Exception : Exception
{
    ...
    /// </summary>
    public PAWCP2Exception(string message)
    {
    ...
    public PAWCP2Exception(Exception ex)
    {
        exception = ex;
    }
    ...
    public static PAWCP2Exception MustThrow()
    {
        return new PAWCP2Exception();
    }

    /// <summary>
    /// Throws a new instance of <see cref="PAWCP2Exception"/>.
    /// </summary>
    /// <returns>This method does not return a value.</returns>
    public static PAWCP2Exception MustThrow(string message)
    {
        return new PAWCP2Exception(message);
    }
    ...
    /// <param name="ex">The inner exception that caused this exception.</param>
    /// <returns>This method does not return a value.</returns>
    public static PAWCP2Exception MustThrow(Exception ex)
    {
        return new PAWCP2Exception(ex);
    }
